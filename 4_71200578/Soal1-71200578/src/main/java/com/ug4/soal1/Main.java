...
public class Main {
    ...
    private static void menu(Passenger passenger, Bus bus){
        ...
        if(passenger.balance < bus.fares){
            System.out.println("Balance anda tidak cukup");
        }
        else {
            System.out.print("Balance anda cukup");
            bus.getPassenger(passenger);
        }
        System.out.println("============================================\n\n\n");
    }
    ...
    private static void showDestination(
        ...
        if(destiny.isEmpty()) {
            System.out.println("Destinasi yang anda pilih tidak ditemukan");
        }
        else{
